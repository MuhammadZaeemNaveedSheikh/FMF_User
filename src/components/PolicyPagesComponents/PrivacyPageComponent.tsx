      ...
      >
        <div className="w-full md:w-[70%]" id="content">
          ...
          <Typography sx={stylesMui.policyText}>
            ...
            or links to this policy <br />
            <br />
            “Services,” we are referring to our Website, and other related
            services, including any sales, marketing, or events The purpose of
            ...
            Services immediately. Please read this privacy notice carefully, as
            ...
            <br />
            WHO WILL YOUR INFORMATION BE SHARED WITH? HOW LONG DO WE KEEP YOUR
            INFORMATION? <br />
            <br />
            HOW DO WE KEEP YOUR INFORMATION SAFE? DO WE COLLECT INFORMATION FROM
            MINORS? <br />
            <br />
            WHAT ARE YOUR PRIVACY RIGHTS? CONTROLS FOR DO-NOT-TRACK FEATURES DO
            CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS? <br />
            <br />
            DO WE MAKE UPDATES TO THIS NOTICE? HOW CAN YOU CONTACT US ABOUT THIS
            NOTICE? <br />
            <br />
            ...
            the Website, express an interest in obtaining information about us
            ...
            may include the following: Personal Information Provided by You. We
            collect names; phone numbers; email addresses; mailing addresses;
            contact preferences; and other similar information. Payment Data. We
            ...
            their privacy notice link(s) here: (INPUT PAYMENT PROCESSOR PRIVACY
            AGREEMENT LINK HERE) All personal information that you provide to us
            ...
            reporting purposes. The information we collect includes: Log and
            Usage Data. Log and usage data is service-related, diagnostic, usage
            ...
            (sometimes called ‘crash dumps’) and hardware settings). Location
            ...
            to use certain aspects of the Services. <br />
            <br /> HOW DO WE USE YOUR INFORMATION? <br />
            <br />
            ...
            enable user-to- user communications with each user’s consent. To
            ...
            policies. To protect our Services. We may use your information as
            part of our efforts to keep our Website safe and secure (for
            example, for fraud monitoring and prevention). To enforce our terms,
            conditions and policies for business purposes, to comply with legal
            and regulatory requirements or in connection with our contract. To
            respond to legal requests and prevent harm. If we receive a subpoena
            or other legal request, we may need to inspect the data we hold to
            determine how to respond. Fulfill and manage your orders. We may use
            your information to fulfill and manage your orders, payments,
            returns, and exchanges made through the Website. Administer prize
            draws and competitions. We may use your information to administer
            prize draws and competitions when you elect to participate in our
            competitions. To deliver and facilitate delivery of services to the
            user. We may use your information to provide you with the requested
            service. To respond to user inquiries/offer support to users. We may
            use your information to respond to your inquiries and solve any
            potential issues you might have with the use of our Services. To
            ...
            and to measure its effectiveness. For other business purposes. We
            ...
            our promotional campaigns and to evaluate and improve our Website,
            ...
            information. WILL YOUR INFORMATION BE SHARED WITH ANYONE? In Short:
            We only share information with your consent, to comply with laws, to
            provide you with services, to protect your rights, or to fulfill
            business obligations. We may process or share your data that we hold
            based on the following legal basis: <br />
            <br />
            ...
            another company. Vendors, Consultants and Other Third-Party Service
            ...
            Website, which will enable them to collect data on our behalf about
            how you interact with our Website over time. This information may be
            ...
            are under common control with us. Business Partners. We may share
            your information with our business partners to offer you certain
            products, services or promotions. WHO WILL YOUR INFORMATION BE
            SHARED WITH? In Short: We only share information with the following
            categories of third parties. We only share and disclose your
            information with the following categories of third parties. If we
            ...
            THIS NOTICE?”. Payment Processors Ad Networks Data Analytics
            Services Finance & Accounting Tools Order Fulfillment Service
            Provider User Account Registration & Authentication Services HOW
            LONG DO WE KEEP YOUR INFORMATION? In Short: We keep your information
            for as long as necessary to fulfill the purposes outlined in this
            privacy notice unless otherwise required by law. We will only keep
            ...
            keeping your personal information for longer than six (6) months
            past the termination of the user’s account. When we have no ongoing
            ...
            until deletion is possible. HOW DO WE KEEP YOUR INFORMATION SAFE? In
            Short: We aim to protect your personal information through a system
            of organizational and technical security measures. We have
            ...
            Website within a secure environment. DO WE COLLECT INFORMATION FROM
            MINORS? In Short: We do not knowingly collect data from or market to
            ...
            applicable data protection laws. If we are relying on your consent
            to process your personal information, you have the right to withdraw
            your consent at any time. Please note however that this will not
            ...
            are a resident in the EEA or UK and you believe we are unlawfully
            processing your personal information, you also have the right to
            complain to your local data protection supervisory authority. You
            can find their contact details here:
            https://ec.europa.eu/justice/data-protection/bodies/authorities/
            index_en.htm. If you are a resident in Switzerland, the contact
            ...
            information provided. CONTROLS FOR DO-NOT-TRACK FEATURES Most web
            ...
            privacy notice. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY
            ...
            backups, etc.). DO WE MAKE UPDATES TO THIS NOTICE? In Short: Yes, we
            ...
            request form by clicking here. NOTES: have developer input a link to
            a support ticket with subject automatically titled “Removal of
