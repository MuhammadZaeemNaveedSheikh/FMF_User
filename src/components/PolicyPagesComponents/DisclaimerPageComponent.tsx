      ...
      >
        <div className="w-full md:w-[70%]" id="content">
          ...
          <Typography sx={stylesMui.policyText}>
            ...
            INFORMATION ON THE SITE IS SOLELY AT YOUR OWN RISK. <br />
            <br />
            ...
            trading of investment instruments. Trading in financial markets is a
            high-risk activity and it is advised not to risk more than one can
            afford to lose Funded Account Disclaimer: Hypothetical or simulated
